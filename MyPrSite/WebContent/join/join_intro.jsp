	...
	<section class="join_intro1">
		...
		<form name="join_intro1" action="join.jsp" method="get">
			<ul>
				...
				<li>
					<div><input type="checkbox" name="join_check1"  id="chk1" class="join_check">사람온 이용약관 동의<span class="opt">(필수)</span></div>
					<textarea>여러분을 환영합니다.
...
단체회원 계정 사용에서의 관리자, 멤버 등의 권한 및 (공동)책임에 관한 사항 등은 계정 운영정책 및 고객센터 내 사람온 단체회원(단체 아이디) 소개 등에서 확인해 주시기 바랍니다.
				...
				<li>
					<div><input type="checkbox" name="join_check2"  id="chk2" class="join_check">개인정보 수집 및 이용 동의<span class="opt">(필수)</span></div>
...
이와 같이 수집된 정보는 개인정보와의 연계 여부 등에 따라 개인정보에 해당할 수 있고, 개인정보에 해당하지 않을 수도 있습니다.
				...
				<li>
					<div><input type="checkbox" name="join_check3" class="join_check">위치정보 이용약관 동의<span class="opt1">(선택)</span></div>
...
②제1항 위치기반서비스의 이용요금은 무료입니다.
				...
				<li>
					<input type="checkbox" name="join_check4" class="join_check">프로모션 정보 수신 동의<span class="opt">(선택)</span>
				</li>
				<li>
